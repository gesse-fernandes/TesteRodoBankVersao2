...
<div class="form-row">
        <div :class="['form-group col', {'has-error': errors.board}]">
        ...
        <div :class="['form-group col', {'has-error': errors.vehicle_owner}]">
        ...
        <div class="form-row">
        <div :class="['form-group col', {'has-error': errors.price_freight}]">
        ...
        <div :class="['form-group col', {'has-error': errors.date_start}]">
         ...
         <div class="form-row">
        <div :class="['form-group col', {'has-error': errors.date_end}]">
           ...
           <div :class="['form-group col',{'has-error':errors.status}]">
                 <label >Status:</label>
                ...
                <span v-if="freight.status"></span>
                <span v-else>{{freight.status}}</span>
